...
from shellyhtcollector.shellyhtcollector.Database import MeasurementDatabase
from shellyhtcollector.shellyhtcollector.Utils import DatetimeEncoder
...
if args.html:
    ...
    print(
        json.dumps(db.retrieveLastMeasurement(args.stationid), cls=DatetimeEncoder)
    )
